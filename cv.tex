...
\begin{itemize}
    ...
    \item \textbf{\spa{Lenguajes de programación}\en{Programming languages}:} C, Python, C\#/Unity, Javascript, Smalltalk.
    ...
    \item \textbf{\spa{Diagramación lógica, algoritmos y estructuras de datos.}\en{Algorythms and data structures}}
    \item \textbf{\spa{Bases de datos relacionales}\en{Relational databases}} / SQL.
    
    \item {\spa{Otras herramientas}\en{Other tools}:} Git, GNU Make, Cuis, Linux.
